...
![Observed False Negatives](project_bloom/results/observed_fneg.png)
...
![Observed False Positive Rate](project_bloom/results/observed_fpr.png)
...
![Theoretical False Positive Rate](project_bloom/results/theoretical_fpr.png)
...
![Observed vs Theoretical False Positive Rates](project_bloom/results/exp_vs_obs_fpr_by_item.png)

![Observed vs Theoretical False Positive Rates by Target Rate](project_bloom/results/exp_vs_obs_fpr_by_fpr.png)
...
![Total Insertion Time](project_bloom/results/total_insert_time.png)
...
![Average Insertion Time](project_bloom/results/avg_insert_time.png)
...
![Total Lookup Time for Absent Elements](project_bloom/results/total_search_absent_time.png)
![Total Lookup Time for Present Elements](project_bloom/results/total_search_present_time.png)
...
![Average Lookup Time for Absent Elements](project_bloom/results/avg_search_absent_time.png)
![Average Lookup Time for Present Elements](project_bloom/results/avg_search_present_time.png)
...
![Total Storage in Bits](project_bloom/results/total_storage.png)
...
![Average Bits per Item](project_bloom/results/used_bits_per_item.png)
...
![Compression Rate versus False Positive Rate](project_bloom/results/compression_vs_fpr.png)
...
![Memory Size versus Inserted Elements](project_bloom/results/elements_vs_size.png)
